...
import { getPageMeta, TERMS_META } from '@/lib/server-i18n'
...
export async function generateMetadata(
  ...
  const { title, description } = getPageMeta(TERMS_META, lang)
  const canonicalUrl = `${BASE}/${lang}/terms-of-use`
  return {
    title,
    description,
    alternates: buildAlternates(canonicalUrl, '/terms-of-use'),
