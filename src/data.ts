...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    keywords: ['color', 'replace', 'tint', 'change color of image'],
    mvp: true,
    title: 'Change Image Color Online Free — Replace & Tint',
    subtitle: 'Change the color of any part of an image free in your browser. Replace, tint, or swap hues — private, no signup. JPG, PNG, WebP, GIF.',
  ...
  },
  {
    ...
    keywords: ['gif', 'animation', 'frames', 'gif maker free'],
    mvp: true,
    title: 'GIF Maker Free — Images to Animated GIF, No Upload',
    subtitle: 'Make a GIF free in your browser: drop images, set speed and size, download with no watermark. Local processing — no upload, no signup.',
  ...
  },
  {
    ...
    name: 'GIF Compressor',
    category: 'create-more',
    description: 'Compress animated GIFs locally to Discord / KB targets.',
    keywords: ['gif compressor', 'compress gif', 'optimize gif', 'discord'],
    mvp: true,
    title: 'GIF Compressor — Shrink GIFs Locally to Discord Size',
    subtitle: 'Compress animated GIFs in your browser. Hit Discord, 512KB, or 5MB targets with quality, frame, and palette controls. Free, no upload, no signup.',
    tips: ['Use Discord / 512KB / 5MB presets for platform limits.', 'Lower palette and scale shrinks most.'],
  },
  {
    slug: 'meme-generator',
    name: 'Meme Generator',
  ...
  },
  {
    ...
    keywords: ['blur', 'privacy', 'hide', 'blur image'],
    mvp: true,
    title: 'Blur Image Online Free — Faces & Plates, Private in Browser',
    subtitle: 'Blur faces, license plates, or backgrounds free in your browser. Selective brush blur, private local processing, no signup. JPG, PNG, WebP.',
